...
ffig = "../out/PH Vel PC 3p-Dixon/FIGURES DIXON/";
mkdir(ffig);

load('../out/PH Vel PC 3p-Dixon/MAT/WFV_GROUND_TRUTH.mat','WFV');
...
ffig = "../out/PH Vel PC 3p-Dixon/FIGURES DIXON NT/";
mkdir(ffig);
